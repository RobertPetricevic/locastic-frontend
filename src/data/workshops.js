const workshops = [
  ...
  },
  {
    ...
    desc:
      "Online shopping behaviour is usually based on emotion which is mostly triggered by originality and can’t be quantified by statistics. Everyone knows that, but still, there is an alarming situation happening in the world of E-commerce. Online shopping is ruled by overthought designs that are based on statistics that eventually result in every webshop being the same. At the 30th edition of Tinel that's taking place in late November, ICT županija helped us bring Julian Mollema, lead designer from one of the top Dutch digital agencies - Build in Amsterdam.",
    price: 450,
  ...
  },
  {
    ...
    desc:
      "Cal Evans is author of five Leanpub books, Signaling PHP, Iterating PHP Iterators, Going Pro, Culture of Respect, and Uncle Cal’s Career Advice to Developers. After 15 years of work with MySQL and PHP - he switched his focus on building (better) developers through dev trainings in EICC, Zend, and Kony Solutions.",
    price: 500,
  ...
  },
  {
    ...
    desc:
      "Our guest is the Front-end developer and React superstar Sara Vieira who will host a talk on the new way to approach React development. React is a great tool to allow developers and designers to collaborate and build amazing apps and components together. This workshop is directed at people that have no experience with React to get them ready to build React components.",
    price: 350,
    date: "2020-02-23T13:51:50.417-07:00",
    category: "frontend",
    userId: 10,
    imageUrl:
      "https://secure.meetupstatic.com/photos/event/5/4/c/f/600_477021711.jpeg",
  },
  {
    id: 11,
    ...
    userId: 11,
    imageUrl:
      "https://secure.meetupstatic.com/photos/event/7/d/5/b/600_479192091.jpeg",
  },
  {
    id: 12,
    title: "Web Performance Optimization",
    desc:
      "At the upcoming Tinel on Thursday, our guest will host a LIVE Web Performance Optimization session. We will move away from the classic presentation format as Harry will be doing live coding on the spot, helping you to enhance the website speed. You can expect a lot of tips and tricks from one of the best industry experts who worked for Google, UN, Etsy, BBC, and more. The event is taking place on the 30th of May, we strongly suggest that you confirm your place as soon as possible - you’re in for a treat!",
    price: 450,
